...
@mcp_server("ThermoelectricMaterialsServer", "Thermoelectric materials screening with CALYPSO", author="@liuyuxiang92", category="Materials Science")
def create_server(host="0.0.0.0", port=50001):
    """Create and configure the MCP server instance."""
    mcp = CalculationMCPServer("ThermoelectricMaterialsServer", host=host, port=port)
