...
def process_job(job_data: str) -> str:
    ...
    Args:
        job_data (str): JSON string containing job specifications.
            ...
            {
                "job_type": "single_point", // MUST BE ONE OF "single_point", "geometry_optimization", "frequency_analysis", "population_analysis", "TDDFT", "NMR".
...
def run_dynamic_job(code: str, molecule_xyz: str, params: dict) -> dict:
    ...
    Args:
        ...
        molecule_xyz (str): The XYZ string of the molecule.
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            os.chdir(tmpdir)
            mol_file = os.path.join(tmpdir, "molecule.xyz")
            ...
            result = {"status": "success", "output": exec_result.stdout}
    except Exception as e:
